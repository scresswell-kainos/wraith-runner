...
module.exports = function (phantom, ready) {
    ...
    if (session_config[page_location] != undefined) {
        body = {
            "user": {
        ...
        if (phantom.url.indexOf('localhost') > -1) {
            ...
            populate_session('http://localhost:8001/v1.0/sessions', local_session_key, body)
            phantom.addCookie({
                'name': 'AccessToken',
            ...
            populate_session('http://llc-preview-auth.service.dev.ctp.local:8091/v1.0/sessions', preview_session_key, body)
            phantom.addCookie({
                'name': 'AccessToken',
            ...
            populate_session('http://llc-integration-auth.service.dev.ctp.local:8091/v1.0/sessions', integration_session_key, body)
            phantom.addCookie({
                'name': 'AccessToken',
